...
cumbersome \code{f *> (`f (fun ...))}.\footnote{There exists a fourth
  ...
  of the libarary writer. OCaml provides the \code{Obj.magic}
...
function \code{h} appears, nor do we care when the excution order is
\code{f;g;f}, because \code{f} has already occured before \code{g}.
